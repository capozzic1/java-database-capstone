...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(@NonNull CorsRegistry registry) {
        ...
        registry.addMapping("/**")
                .allowedOrigins("http://localhost:4200", "http://localhost:4000", "http://angular-ssr-env.eba-puibsgme.us-east-1.elasticbeanstalk.com")  // restrict wildcard when using credentials
